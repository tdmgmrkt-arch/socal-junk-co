        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                To exercise these rights, please contact us at <a href="mailto:info@socaljunk.net" className="text-gold hover:underline">info@socaljunk.net</a> or call us at <a href="tel:+13102187822" className="text-gold hover:underline">(310) 218-7822</a>.
              </p>
            </div>
