...
export const metadata: Metadata = {
  title: "Junk Removal in Irvine, CA",
  description:
    "Fast, eco-friendly junk removal in Irvine, CA. Residential and commercial hauling, furniture and appliance removal, and same-day service. Licensed, insured, free quotes.",
  alternates: {
    canonical: "/service-areas/irvine",
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "Service Areas",
      item: "https://socaljunkco.com/service-areas",
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Irvine",
      item: "https://socaljunkco.com/service-areas/irvine",
    },
  ],
}
...
const serviceSchema = {
  ...
  url: "https://socaljunkco.com/service-areas/irvine",
}

export default function IrvineJunkRemovalPage() {
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-gold/20 backdrop-blur-sm px-4 py-2 rounded-full border border-gold/30 mb-6">
              ...
              <span className="text-sm font-semibold text-gold">Serving Irvine, CA</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Junk Removal in <span className="text-gold">Irvine, CA</span>
            </h1>
            <p className="text-xl sm:text-2xl text-gray-300 mb-8">
              Fast, eco-friendly junk hauling for Irvine homes and businesses. Same-day appointments, upfront pricing, and a truck nearby.
            </p>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-black mb-6">
            Irvine's Local Junk Removal Team
          </h2>
          <div className="space-y-4 text-gray-700 text-lg">
            <p>
              As one of our primary Orange County service areas, Irvine gets fast turnaround from our Anaheim-based team — often with same-day availability. Whether you're clearing out a home in Woodbridge or Northwood, prepping an office in the Irvine Business Complex, or managing a multi-unit cleanout near UC Irvine, we bring the truck and the crew to you.
            </p>
            <p>
              We handle everything from single-item pickups to full property cleanouts, and we recycle or donate roughly 75% of what we collect instead of sending it straight to a landfill — something Irvine's environmentally-conscious community tends to appreciate.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Every service we offer, available throughout Irvine and the surrounding area
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">
              Why Irvine Chooses SoCal Junk Co
            </h2>
          </div>
      ...
      <section className="relative py-20 sm:py-28 bg-gradient-to-br from-black via-gray-980 to-black text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Get a free, no-obligation quote for your Irvine junk removal job today.
          </p>
